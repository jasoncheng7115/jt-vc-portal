...
curl -LO https://github.com/jasoncheng7115/jt-vc-portal/releases/download/v1.3.0/jt-vc-portal-1.3.0-docker-amd64.tar.gz
curl -LO https://github.com/jasoncheng7115/jt-vc-portal/releases/download/v1.3.0/jt-vc-portal-1.3.0-docker-amd64.tar.gz.sha256

# 2) 驗證完整性（應顯示 OK）
sha256sum -c jt-vc-portal-1.3.0-docker-amd64.tar.gz.sha256

# 3) 載入映像（會建立 jt-vc-portal:1.3.0 與 :latest 標籤）
docker load < jt-vc-portal-1.3.0-docker-amd64.tar.gz
